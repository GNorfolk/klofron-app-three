    ...
    <main>
      ...
      { familyData.length > 0 ? familyData.map(({ family_id, family_name, family_people, family_houses }) => (
        <a href={`/family/${family_id}`} className="p-6 pt-2 pb-2">
          <h3 className="text-xl font-semibold text-gray-200">The {family_name} family</h3>
        ...
        <a className="p-6 pt-2 pb-2">
          <h3 className="text-xl font-semibold text-gray-200">The user has no families!</h3>
        </a>
      }
    </main>
  )
